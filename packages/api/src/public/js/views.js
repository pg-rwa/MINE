  ...
  async chat() {
    ...
    return `
      <div class="chat-layout">
        ...
        <div class="activity-panel-right" id="activityPanel">
          <div class="activity-panel-header">
            <div class="activity-panel-title">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="22,12 18,12 15,21 9,3 6,12 2,12"/></svg>
              Agent Activity
              <span class="activity-live-dot" id="activityStatus">Live</span>
            </div>
            <button class="btn-icon" onclick="App.clearActivity()" title="Clear activity" style="width:28px;height:28px">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="3,6 5,6 21,6"/><path d="M19,6v14a2,2,0,0,1-2,2H7a2,2,0,0,1-2-2V6m3,0V4a2,2,0,0,1,2-2h4a2,2,0,0,1,2,2v2"/></svg>
            </button>
          </div>
          <div class="activity-feed" id="activityFeed">
            <div class="activity-empty">No activity yet. Send a message to see live agent activity.</div>
          </div>
        </div>
      </div>
    `;
